...
// Fortnite缺失的CPU列表
const MISSING_CPUS = [
  'Core i3-12300', 'Core i3-13100', 'Core i3-13100F', 'Core i5-13600',
  'Core i5-13600KF', 'Core i5-14600', 'Core i7-11700K', 'Core i7-11700KF',
  'Core i7-12700KF', 'Core i7-13700', 'Core i7-14700', 'Core i9-11900K',
  'Core i9-11900KF', 'Core i9-12900F', 'Core i9-13900KF', 'Ryzen 3 5300G',
  'Ryzen 5 5600G', 'Ryzen 5 5600GT', 'Ryzen 5 5600XT', 'Ryzen 7 5800',
  'Ryzen 9 9850X3D'
];
...
const MISSING_GPUS = [
  ...
  'RTX 4080 Super', 'RX 6500 XT', 'RX 970', 'Radeon RX 6400', 'Radeon RX 6500 XT',
  'Radeon RX 6600 XT', 'Radeon RX 6650 XT', 'Radeon RX 6700', 'Radeon RX 6700 XT',
  'Radeon RX 6800', 'Radeon RX 6800 XT', 'Radeon RX 6900 XT', 'Radeon RX 7650 GRE',
  'Radeon RX 9060 XT', 'Radeon RX 9060 XT 16GB', 'Radeon RX 9070', 'Radeon RX 9070 XT'
];
...
async function main() {
  ...
  let cpuFileContent = `# Fortnite CPU 帧率数据 — HowManyFPS\n## 游戏: Fortnite\n## 采集时间: ${new Date().toISOString().split('T')[0]}\n\n`;
  cpuFileContent += `| CPU | 分辨率 | Real-Time Average | 1% Lows |\n|-----|--------|-------------------|--------|\n`;

  let gpuFileContent = `# Fortnite GPU 帧率数据 — HowManyFPS\n## 游戏: Fortnite\n## 采集时间: ${new Date().toISOString().split('T')[0]}\n\n`;
  gpuFileContent += `| GPU | 分辨率 | Real-Time Average | 1% Lows |\n|-----|--------|-------------------|--------|\n`;

  console.log('开始采集 Fortnite 缺失的 CPU 数据...');
  ...
  fs.writeFileSync(`${DATA_DIR}/howmanyfps_fortnite_cpu_data_new.md`, cpuFileContent);
  console.log('\nCPU数据已保存');

  console.log('\n\n开始采集 Fortnite 缺失的 GPU 数据...');
  ...
  fs.writeFileSync(`${DATA_DIR}/howmanyfps_fortnite_gpu_data_new.md`, gpuFileContent);
  console.log('\nGPU数据已保存');

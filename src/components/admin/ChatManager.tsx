                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className={`text-xs truncate ${session.unreadCount > 0 ? 'text-slate-600 font-medium' : 'text-slate-400'}`}>
                                            {(session.lastMessage && typeof session.lastMessage === 'object' && 'content' in session.lastMessage) ? (session.lastMessage as ChatMessage).content : (typeof session.lastMessage === 'string' ? session.lastMessage : '暂无消息')}
                                        </p>
                                    </div>
                                </button>
                            ))

...
export const LIVE_STYLES: Record<LiveStyleKey, LiveStyleConfig> = {
    ...
    pixel: {
        ...
        frameTreatment: 'soft',
        frameMotion: 'pulse',
        wrapperBg: 'bg-[#f7fbf4] bg-[radial-gradient(circle_at_10%_10%,rgba(250,204,21,0.12),transparent_25%),radial-gradient(circle_at_92%_88%,rgba(34,197,94,0.12),transparent_30%)]',
        sectionBg: 'bg-[#fffdf8] border-2 border-[#e5b44c]',
        panelBg: 'bg-white/90',
        ...
        divider: 'divide-[#d9b76e]/30',
        headerBg: 'bg-gradient-to-r from-[#fff3cf] via-white to-[#ecfdf3] border-b border-[#e9bf64]',
        border: 'border-[#d8b05c]',
        accentText: 'text-[#d88b13]',
        fpsBarColor: 'bg-gradient-to-r from-[#22c55e] via-[#facc15] to-[#f97316]',
        savedBadge: 'bg-[#fff2b8] text-[#6b451b] border border-[#e0af49] shadow-sm',
        mutedText: 'text-[#7c6040]',
        glowBg: 'bg-[#22c55e]',
        rowBg: 'bg-[#fff8dc]',
        stampBorder: 'border-[#e2b452]',
    },
    pixelWhite: {
        name: '像素白板',
        emoji: '□',

...
export const LIVE_STYLES: Record<LiveStyleKey, LiveStyleConfig> = {
    ...
    pixel: {
        ...
        frameTreatment: 'tech',
        frameMotion: 'pulse',
        wrapperBg: 'bg-[#111827] bg-[linear-gradient(90deg,rgba(56,189,248,0.10)_1px,transparent_1px),linear-gradient(0deg,rgba(56,189,248,0.10)_1px,transparent_1px)] bg-[length:16px_16px]',
        sectionBg: 'bg-[#172033] border-4 border-[#93c5fd]',
        panelBg: 'bg-[#1f2b3d]',
        categoryText: 'text-[#bfdbfe] font-black',
        modelText: 'text-[#fff8e7] font-black',
        priceText: 'text-[#fbbf24] font-black',
        totalPriceText: 'text-[#fbbf24]',
        divider: 'divide-[#93c5fd]/25',
        headerBg: 'bg-[#121c2e] border-b-4 border-[#93c5fd]',
        border: 'border-[#93c5fd]',
        accentText: 'text-[#67e8f9]',
        fpsBarColor: 'bg-[repeating-linear-gradient(90deg,#38bdf8_0_12px,#93c5fd_12px_24px,#fbbf24_24px_30px)]',
        savedBadge: 'bg-[#fbbf24] text-[#111827] border-2 border-[#93c5fd] shadow-[3px_3px_0_#050b16]',
        mutedText: 'text-[#8ea4bf]',
        glowBg: 'bg-[#38bdf8]',
        rowBg: 'bg-[#1b2638]',

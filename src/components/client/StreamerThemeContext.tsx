...
export const LIVE_STYLES: Record<LiveStyleKey, LiveStyleConfig> = {
    ...
    pixel: {
        ...
        frameTreatment: 'tech',
        frameMotion: 'pulse',
        wrapperBg: 'bg-[#5c94fc] bg-[radial-gradient(ellipse_at_18%_14%,#ffffff_0_12px,transparent_13px),radial-gradient(ellipse_at_74%_20%,#ffffff_0_15px,transparent_16px),linear-gradient(#5c94fc,#93c5fd)]',
        sectionBg: 'bg-[#5c94fc] border-4 border-[#1e3a8a]',
        panelBg: 'bg-[#fff4cf]',
        categoryText: 'text-[#b91c1c] font-black',
        modelText: 'text-[#1f2937] font-black',
        priceText: 'text-[#b45309] font-black',
        totalPriceText: 'text-[#dc2626]',
        divider: 'divide-[#2563eb]/25',
        headerBg: 'bg-[#5c94fc] bg-[linear-gradient(90deg,rgba(255,255,255,0.22),transparent_42%,rgba(255,255,255,0.18))] border-b-4 border-[#facc15]',

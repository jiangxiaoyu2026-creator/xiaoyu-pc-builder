...
time.sleep(2) # Give it 2 seconds to delete

try:
    with open(local_zip, "rb") as f:
        file_bytes = f.read()
except FileNotFoundError:
    print(f"File {local_zip} not found! Run 'zip -r dist.zip dist' locally first.")
    sys.exit(1)
...
print("Unpacking dist and seamlessly overriding remote files...")
unpack_cmd = f"""
cd /root/pcbuilder

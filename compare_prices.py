...
OLD_FILE = "/Users/mac/new/台式电脑回收核价表4.7.xlsm"
NEW_FILE = "/Users/mac/new/台式机核价专用免费版4.21xlsm.xlsm"
...
def main():
    ...
    for category in SHEETS_TO_CHECK:
        ...
        print(f"\n[{category}]:")
        print(f"  Total compared: {up_count + down_count + same_count}")
